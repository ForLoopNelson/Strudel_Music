...
$drums:stack(s("bd:1").beat("0,7?,10",16).duck("3"),
             s("sd:2").beat("4,12",16),
             s("hh:4!8").bank("akaimpc60").orbit(2).spiral({steady: .75, activeColor:10, thickness: 6}))


$bass: stack(s("supersaw!8").note("<c# f d# [d# a#2]>/2".sub(12)).orbit(3).gain(1.06).color("red")._scope(),
